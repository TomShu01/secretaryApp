...
functions: secretaryApp is a tool that is designed to filter out grunt work and makes daily life a lot simpler and eliminate repetitions of useless work by performing the following functions:
...
· Based on my preferences (machine learning from reflections as well), automatically adjusts my schedule
...
· I then spent around 2 days building a prototype, which is the one I sent you:
